      ...
      <>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0B1220] border border-[#1F2937] rounded-lg p-6">
               ...
               <p className="text-3xl font-bold text-white">{portfolio?.length || 0}</p>
         ...
         <div className="bg-[#0B1220] border border-[#1F2937] rounded-lg p-6">
            <h2 className="text-xl font-bold text-white mb-4">Recent Holdings</h2>
                  ...
                  {portfolio.slice(0, 5).map((stock: Portfolio) => (
                     ...
                     >
                        <div>
                           ...
                           <p className="text-sm text-gray-300">{stock.companyName}</p>
                        </div>
